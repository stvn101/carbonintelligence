      ...
      >
        ...
        <nav className="flex-1 py-6 overflow-y-auto">
          <div className="px-4 space-y-3">
            ...
            <Link href="/carbon-dashboard" data-testid="nav-carbon-dashboard">
              <div className={getNavItemClasses("/carbon-dashboard")}>
                <BarChart3 className="w-5 h-5 flex-shrink-0" />
                <span className={`text-sm ${isActive("/carbon-dashboard") ? "font-semibold" : "font-medium"}`}>Carbon Dashboard</span>
              </div>
            </Link>

            {/* Material Comparison */}
            <Link href="/material-comparison" data-testid="nav-material-comparison">
              <div className={getNavItemClasses("/material-comparison")}>
                <Package className="w-5 h-5 flex-shrink-0" />
                <span className={`text-sm ${isActive("/material-comparison") ? "font-semibold" : "font-medium"}`}>Material Comparison</span>
              </div>
            </Link>

            {/* Project Analysis */}
            <Link href="/project-analysis" data-testid="nav-project-analysis">
              <div className={getNavItemClasses("/project-analysis")}>
