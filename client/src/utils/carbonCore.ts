...
export const australianRegions = {
  ...
  cities: {
    ...
    Perth: { state: 'wa', gridFactor: 0.70 },
 ...
 */
export const getMaterialCarbonData = async (category: string, type: string, context: any = {}) => {
 ...
 * @returns LCA results
 */
export const calculateMaterialLCA = (material: any, quantity: number, projectLife: number, options: any = {}) => {
 ...
 */
export const calculateProjectLCA = (materials: any[], projectLife: number, options: any = {}) => {
  const calculator = getLCACalculator();
